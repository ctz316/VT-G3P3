package com.skillstorm.project3.security;
...
public class UserSecGenerator {
	
	private static UserSecGenerator gen = null;
	
//	private HashMap<String, String> salts;
//	private final String saltsFile;
		
	private UserSecGenerator() {
...
//	
	...
	public static UserSecGenerator getInstance() {
		if (gen == null) {
			gen = new UserSecGenerator();
		}
		return gen;
	}
}
